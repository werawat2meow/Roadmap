...
export const MenuHRMS = [
  ...
  {
    title: "นโยบายและแผน (POLICY & PLANNING)",
    icon: "FileProtectOutlined",
    items: [
      { label: "นโยบายบริษัท", href: "/admin/hr-policies", icon: "FileProtectOutlined", permission: "policy.hr_policies.view" },
      { label: "นโยบายค่าตอบแทน (Compensation Policy)", href: "/admin/compensation-policies", icon: "DollarOutlined", permission: "policy.compensation_policies.view" },
      { label: "ระเบียบข้อบังคับพนักงาน (Employee Handbook)", href: "/admin/employee-handbooks", icon: "ReadOutlined", permission: "policy.employee_handbooks.view" },
      { label: "นโยบายการปฏิบัติตามกฎหมาย / PDPA", href: "/admin/compliance-policies", icon: "SafetyCertificateOutlined", permission: "policy.compliance_policies.view" },
      { label: "แผนกลยุทธ์ HR", href: "/admin/hr-strategic-plans", icon: "AimOutlined", permission: "policy.strategic_plans.view" },
      { label: "ประวัติการแก้ไขนโยบาย (Version History)", href: "/admin/policy-versions", icon: "HistoryOutlined", permission: "policy.policy_versions.view" }
    ]
  },

  {
    title: "BENEFIT SYSTEM (สวัสดิการ)",
    icon: "GiftOutlined",
    items: [
      { label: "ประเภทสวัสดิการ", href: "/admin/benefit-types", icon: "GiftOutlined", permission: "benefits.benefit_types.view" },
      { label: "แผนสวัสดิการ", href: "/admin/benefit-plans", icon: "AppstoreOutlined", permission: "benefits.benefit_plans.view" },
      { label: "กฎเกณฑ์สวัสดิการ (Policy Rules)", href: "/admin/benefit-policy-rules", icon: "FileProtectOutlined", permission: "benefits.policy_rules.view" },
      { label: "สิทธิ์สวัสดิการพนักงาน (Entitlements)", href: "/admin/benefit-entitlements", icon: "SolutionOutlined", permission: "benefits.entitlements.view" },
      { label: "คำขอเบิกสวัสดิการ / อนุมัติ", href: "/admin/benefit-approvals", icon: "CheckCircleOutlined", permission: "benefits.approvals.view" },
      { label: "Audit Log สวัสดิการ", href: "/admin/benefit-audit-logs", icon: "AuditOutlined", permission: "benefits.audit_logs.view" }
    ]
  },
...

  {
    ...
    icon: "SafetyOutlined",
    items: [
      { label: "ประกันกลุ่ม", href: "/admin/group-insurance", icon: "SafetyOutlined", permission: "insurance.group_insurance.view" },
      { label: "ประกันสุขภาพพนักงาน", href: "/admin/health-insurance", icon: "HeartOutlined", permission: "insurance.health_insurance.view" }
    ]
  },
...

  {
    ...
    items: [
      { label: "บันทึกอุบัติเหตุ", href: "/admin/incident-records", icon: "WarningOutlined", permission: "ehs.incidents.view" },
      { label: "ตรวจสุขภาพประจำปี", href: "/admin/health-checkups", icon: "MedicineBoxOutlined", permission: "ehs.health_checkups.view" },
      { label: "อบรมความปลอดภัย", href: "/admin/safety-trainings", icon: "SafetyOutlined", permission: "ehs.safety_trainings.view" }
    ]
  },
...

  {
    ...
    icon: "SmileOutlined",
    items: [
      { label: "แบบสำรวจความพึงพอใจ", href: "/admin/engagement-surveys", icon: "FormOutlined", permission: "engagement.surveys.view" },
      { label: "ผลสำรวจ eNPS", href: "/admin/enps-results", icon: "LineChartOutlined", permission: "engagement.enps.view" }
    ]
  },

  {
    title: "GRIEVANCE / WHISTLEBLOWER",
    icon: "AlertOutlined",
    items: [
      { label: "ช่องทางร้องเรียน", href: "/admin/grievances", icon: "AlertOutlined", permission: "grievance.grievances.view" },
      { label: "การจัดการข้อร้องเรียน", href: "/admin/grievance-cases", icon: "FileSearchOutlined", permission: "grievance.cases.view" }
    ]
  },
...

  {
    ...
    items: [
      ...
      { label: "Payroll Cost Analysis", href: "/admin/payroll-cost-analysis", icon: "PieChartOutlined", permission: "analytics.payroll_cost.view" },
      { label: "รายงานการลา / OT", href: "/admin/leave-ot-reports", icon: "BarChartOutlined", permission: "analytics.leave_ot_reports.view" },
      { label: "รายงานตรวจสอบ Compliance", href: "/admin/compliance-audit-reports", icon: "AuditOutlined", permission: "analytics.compliance_audit.view" },
      { label: "Custom Report Builder", href: "/admin/custom-reports", icon: "BuildOutlined", permission: "analytics.custom_reports.view" }
    ]
  },
...

  {
    ...
    icon: "SettingOutlined",
    items: [
      { label: "ตั้งค่าทั่วไป", href: "/admin/system-settings", icon: "SettingOutlined", permission: "system.settings.view" },
      { label: "ตั้งค่าปีงบประมาณ (Fiscal Year)", href: "/admin/fiscal-years", icon: "CalendarOutlined", permission: "system.fiscal_years.view" },
      { label: "ตั้งค่าสกุลเงิน (Currency)", href: "/admin/currencies", icon: "DollarOutlined", permission: "system.currencies.view" },
      { label: "นำเข้าข้อมูล (Data Import)", href: "/admin/data-import", icon: "ImportOutlined", permission: "data.import.view" },
      { label: "ส่งออกข้อมูล (Data Export)", href: "/admin/data-export", icon: "ExportOutlined", permission: "data.export.view" }
    ]
  }
];
