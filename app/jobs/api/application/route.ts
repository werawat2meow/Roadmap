...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const applicationData = {
      ...
      identity_no: personal.identityNo ?? "",
      current_address_no: Number(personal.currentAddressNo ?? 0),
      ...
      serious_crime: personal.seriousCrime ?? null,
      dishonest: personal.dishonest ?? null,
