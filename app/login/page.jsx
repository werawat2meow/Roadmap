 ...
 return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-white to-emerald-50 flex items-center justify-center px-4 py-8">
      <div className="rb-wrap w-full max-w-5xl">
        ...
        <div className="relative z-[2] grid grid-cols-1 lg:grid-cols-2 rounded-[27px] overflow-hidden shadow-2xl bg-white">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-10 space-y-4">
                <div className="rounded-2xl bg-white/10 border border-white/20 p-4 backdrop-blur-sm">
                  ...
                  <p className="text-sm text-emerald-100 mt-1">Keep all employee records in one secure and searchable place.</p>
                </div>
                <div className="rounded-2xl bg-white/10 border border-white/20 p-4 backdrop-blur-sm">
                  <p className="text-sm font-semibold text-white">Organization Structure</p>
                  <p className="text-sm text-emerald-100 mt-1">Manage company, department, branch, and employment setup clearly.</p>
                </div>
                <div className="rounded-2xl bg-white/10 border border-white/20 p-4 backdrop-blur-sm">
                  <p className="text-sm font-semibold text-white">Ready for HR Expansion</p>
                  <p className="text-sm text-emerald-100 mt-1">Extend toward benefits, attendance, leave, and payroll modules later.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center p-6 sm:p-10 bg-white">
            <Card variant="borderless" className="w-full max-w-md shadow-none" styles={{ body: { padding: 0 } }}>
              ...
              <div className="mb-8">
                ...
                <Text className="text-slate-500">Please enter your username and password</Text>
              </div>
