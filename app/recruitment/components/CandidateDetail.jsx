...
import PrintButton from "@/app/recruitment/components/PrintButton";
import PrintArea from "@/app/recruitment/components/PrintArea";

import { Button, Card, Col, Descriptions, Divider, Row, Table, Tag, Typography, Space } from "antd";
...
export default function CandidateDetail({
  ...
  return (
    <>
      {/* ส่วนควบคุม */}
      <div className="no-print justify-self-end">
        <Space>
          <PrintButton />
        </Space>
      </div>
      <div className="print-content" style={{ padding: 24 }} >
        ...
        <PrintArea>
          ...
          >
            ...
            >
              ...
              <Descriptions.Item label="ชื่อ - นามสกุล">
                {value(application.titles?.title_name_th ?? "")+" "+value(application.first_name)+" "+value(application.last_name)}
              </Descriptions.Item>
          ...
          {application.self_presentation_url && (
            <Card className="no-print" title="Presentation" style={{ marginTop: 24 }}>
              <div >
                Presentation URL :{" "}
