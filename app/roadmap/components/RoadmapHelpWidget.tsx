...
const helpItems: HelpItem[] = [
  ...
  },
  {
    ...
    answer:
      'ไปที่เมนู Employee จะแสดงรายชื่อพนักงานทั้งหมด และสามารถค้นหาพนักงานหรือ Filter พนักงานได้ตามต้องการ',
  ...
  },
  {
    title: 'Score',
    answer:
      'วิธีการคำนวณคะแนน = (คะแนนที่ได้ / คะแนนเต็ม) * 100 ทั้งหัวข้อการทำงาน และ หัวข้อวินัยการทำงาน',
    keywords: ['วิธีการคำนวณคะแนน', 'score', 'คะแนน'],
  },
];
