...
export default function PayrollPage() {
  ...
  const handleExportPayrollExcel = async () => {
    ...
    const thaiMonth = new Intl.DateTimeFormat('th-TH', { month: 'long' }).format(new Date());
  ...
  if (isLoading) return <div className="p-10 text-center text-slate-500">กำลังโหลดข้อมูลรายการปรับเงินเดือน...</div>;
