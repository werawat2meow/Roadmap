  ...
  return (
    <div className="space-y-6">
      <label className="text-sm font-semibold text-red-500">
        ** เลือกรายชื่อฝั่งซ้าย เพื่อกำหนดเมนูการใช้งานให้บุคคลนั้น
        และเลือกสถานะ เช่น Admin, Manager, Management
        สถานะจะมีผลกับการใช้งานของเมนู Admin สร้างฟอร์มประเมิน / Manager
        ลงคะแนนฟอร์มจาก Admin / Management อนุมัติรายการ
      </label>
          ...
          {totalPages > 1 && (
            <div className="mt-6 pt-4 border-t border-slate-100">
              <div className="flex flex-col gap-4">
                {/* ส่วนตัวเลขแสดงจำนวน - จัดให้อยู่กึ่งกลางหรือชิดซ้ายแบบสะอาดๆ */}
                <div className="text-[13px] text-slate-500 font-medium text-center sm:text-left">
                  ...
                  จาก <span className="text-slate-900">{users.length}</span>{" "}
                  รายชื่อ
                </div>

                {/* ส่วนปุ่มกด - ปรับเป็น Icon และวงกลม/มน เพื่อประหยัดพื้นที่ */}
