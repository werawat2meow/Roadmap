...
export async function validateEmployeeOrganization(
  ...
  try {
    ...
    */
    ...
    /*
      Enterprise HRMS Rule

      Position เป็น Job Architecture Master
      และไม่ผูกกับ Unit โดยตรง

      unit_positions ใช้สำหรับ Workforce Planning /
      Headcount Target เท่านั้น จึงไม่ใช้เป็นเงื่อนไข
      บังคับในการสร้างหรือแก้ไข Employee

      ความสัมพันธ์แยกเป็น:
      - Organization: Company -> Branch -> Department -> Division -> Unit
      - Job Architecture: Position Family -> Position Level -> Position -> Job

      ฝั่ง Employee Create API มี validatePositionArchitecture()
      ตรวจ Job Architecture ก่อนเข้า Transaction อยู่แล้ว
    */
